...
// node_modules/.pnpm/registry.nlark.com+lodash@4.17.21/node_modules/lodash/lodash.js
var require_lodash = __commonJS({
  "node_modules/.pnpm/registry.nlark.com+lodash@4.17.21/node_modules/lodash/lodash.js"(exports2, module2) {
    (function() {
      var undefined2;
      var VERSION = "4.17.21";
...
(function(PacketType2) {
  PacketType2[PacketType2["ClientHeartBeat"] = 2] = "ClientHeartBeat";
  PacketType2[PacketType2["ServerHeartBeat"] = 3] = "ServerHeartBeat";
  PacketType2[PacketType2["ServerMsg"] = 5] = "ServerMsg";
  PacketType2[PacketType2["ClientAuth"] = 7] = "ClientAuth";
  PacketType2[PacketType2["ServerAuth"] = 8] = "ServerAuth";
})(PacketType || (PacketType = {}));
var CmdType;
(function(CmdType2) {
  CmdType2["DANMU_MSG"] = "DANMU_MSG";
  CmdType2["SEND_GIFT"] = "SEND_GIFT";
  CmdType2["WELCOME"] = "WELCOME";
  CmdType2["WELCOME_GUARD"] = "WELCOME_GUARD";
  CmdType2["SYS_MSG"] = "SYS_MSG";
  CmdType2["PREPARING"] = "PREPARING";
  CmdType2["LIVE"] = "LIVE";
  CmdType2["INTERACT_WORD"] = "INTERACT_WORD";
  CmdType2["ENTRY_EFFECT"] = "ENTRY_EFFECT";
})(CmdType || (CmdType = {}));
...
var Bilibili = class {
  ...
  handleDanmu(type, callback) {
    this.callbacks[type] = callback;
  }
  createConnect() {
    this.socket = import_net.default.createConnection({ port: this.port, host: this.host });
  ...
  handleMsg(body) {
    import_zlib.default.inflate(body, (error, buffer) => {
      if (error === null && buffer) {
        ...
        msgs.forEach((item) => {
          try {
            ...
            const cmd = import_lodash.default.get(obj, "cmd");
  ...
  getRoomID(id) {
    return new Promise((resolve, _reject) => {
      import_http.default.get(`http://api.live.bilibili.com/room/v1/Room/room_init?id=${id}`, (res) => {
        let body = "";
        res.on("data", (data) => {
          body += data;
        });
        res.on("end", () => {
          ...
          this.roomID = import_lodash.default.get(parsed, "data.room_id");
          resolve(parsed);
        });
      });
    });
  ...
  sendSocketData(packageLength, headerLength, version, action, body) {
